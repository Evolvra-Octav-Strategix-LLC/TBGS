              ...
              <div style="padding: 30px;">
                ...
                <div style="background: #2c3e50; color: white; padding: 25px; border-radius: 10px; text-align: center; margin-bottom: 25px;">
                  ...
                  <div style="display: grid; gap: 12px; max-width: 320px; margin: 0 auto;">
                    ...
                    <a href="mailto:info@tbgs.nl" style="background: #34495e; color: white; padding: 14px 18px; border-radius: 8px; text-decoration: none; display: flex; align-items: center; justify-content: center; font-weight: 500; font-size: 16px; transition: background-color 0.3s;">
