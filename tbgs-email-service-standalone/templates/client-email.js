// Enhanced client email template with better branding and file processing information
...
module.exports = (data) => {
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Bedankt ${escapeHtml(data.firstName)}! - TBGS B.V.</title>
      ...
      <div style="max-width: 650px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 40px; border-radius: 15px; margin-bottom: 30px; box-shadow: 0 8px 25px rgba(0,0,0,0.1);">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="font-size: 18px; line-height: 1.8; margin: 0; color: #555;">
              We hebben je aanvraag voor <strong style="color: #e74c3c; background: #fff5f5; padding: 4px 8px; border-radius: 6px;">${escapeHtml(data.selectedService)}</strong> ontvangen en in behandeling genomen.
            </p>
          </div>
          ...
          <div style="margin: 30px 0;">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px;">
              <div style="display: flex; align-items: center; padding: 15px; background: #f8f9fa; border-radius: 10px; border-left: 4px solid #3498db;">
                <div style="background: #3498db; color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold; font-size: 14px;">1</div>
                <div>
              ...
              <div style="display: flex; align-items: center; padding: 15px; background: #f8f9fa; border-radius: 10px; border-left: 4px solid #f39c12;">
                <div style="background: #f39c12; color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold; font-size: 14px;">2</div>
                <div>
              ...
              <div style="display: flex; align-items: center; padding: 15px; background: #f8f9fa; border-radius: 10px; border-left: 4px solid #27ae60;">
                <div style="background: #27ae60; color: white; width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px; font-weight: bold; font-size: 14px;">3</div>
                <div>
          ...
          <div style="margin-top: 30px;">
            <div style="background: #d5f4e6; padding: 20px; border-radius: 10px; border: 1px solid #a3e3c4;">
              ...
              <p style="margin: 0; color: #555; line-height: 1.5;">
                ✅ ${data.filesProcessed} bestand(en) succesvol verwerkt en geoptimaliseerd<br>
        ...
        <div style="background: white; padding: 30px; border-radius: 15px; text-align: center; margin-bottom: 30px; border: 2px solid #e9ecef; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <div style="display: inline-block;">
            <a href="https://wa.me/31614595142?text=Hallo%20Team%20TBGS%2C%20ik%20heb%20zojuist%20een%20aanvraag%20ingediend%20voor%20${encodeURIComponent(data.selectedService)}%20en%20ik%20heb%20een%20vraag..." target="_blank" rel="noopener noreferrer" style="background: linear-gradient(135deg, #25d366 0%, #20b358 100%); color: white; padding: 15px 25px; text-decoration: none; border-radius: 30px; font-weight: 600; display: inline-block; box-shadow: 0 4px 15px rgba(37,211,102,0.3); transition: all 0.3s ease;">
        ...
        <div style="background: #f8f9fa; padding: 25px; border-radius: 10px; margin-bottom: 30px; border: 1px solid #e9ecef;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 0;">
            <tr>
              ...
              <td style="padding: 8px 0; font-weight: 600; color: #2c3e50;">${escapeHtml(data.selectedService)}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666; font-weight: 500;">Contactvoorkeur:</td>
              <td style="padding: 8px 0; font-weight: 600; color: #2c3e50;">${escapeHtml(data.contactPreference)}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666; font-weight: 500;">Ingediend op:</td>
              <td style="padding: 8px 0; font-weight: 600; color: #2c3e50;">${new Date(data.submittedAt).toLocaleDateString('nl-NL')} om ${new Date(data.submittedAt).toLocaleTimeString('nl-NL', { hour: '2-digit', minute: '2-digit' })}</td>
            </tr>
          </table>
        </div>
        ...
        <div style="background: white; padding: 25px; border-radius: 10px; margin-bottom: 20px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <div style="margin-bottom: 15px;">
            <a href="https://tbgs.nl" target="_blank" rel="noopener noreferrer" style="background: #2c3e50; color: white; padding: 8px 15px; text-decoration: none; border-radius: 20px; margin: 5px; display: inline-block; font-size: 14px; font-weight: 500;">
              🏠 tbgs.nl
            </a>
          </div>
        ...
        <div style="text-align: center; color: #999; font-size: 12px; line-height: 1.5;">
          ...
          <p style="margin: 0; opacity: 0.7;">
            TBGS B.V. Email Service Enhanced v2.0 | ${new Date().getFullYear()}
          </p>
        </div>
