...
export default function TotaalBouwSpecialist({ onOpenContactModal }: TotaalBouwSpecialistProps) {
  return (
    <>
          ...
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              <li className="inline-flex items-center">
                <Link href="/" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-tbgs-orange">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm font-medium text-tbgs-orange md:ml-2">Totaal Bouw Specialist</span>
                </div>
              </li>
            </ol>
          </nav>
      ...
      {/* Specialist Cards */}
      <SpecialistCards currentSpecialist="TBS" showTitle={false} compact={true} />
