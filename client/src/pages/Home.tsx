...
export default function Home({ onOpenContactModal }: HomeProps) {
  ...
  return (
    <>
      ...
      {/* Onze Diensten - Service Cards Section */}
      <section className="py-12 lg:py-20 bg-gradient-to-br from-white to-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-light">
              Ontdek onze <strong>specialisatiediensten</strong> en vind direct de juiste expert voor uw project.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {/* Daklekkage Service */}
            <Link href="/nl/eindhoven/daklekkage">
              <div className="group bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:border-tbgs-red transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-red-50 to-red-100 rounded-xl flex items-center justify-center mx-auto group-hover:from-tbgs-red group-hover:to-red-600 transition-all duration-500">
                    <i className="fas fa-tint text-2xl text-tbgs-red group-hover:text-white transition-colors duration-500"></i>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-tbgs-red transition-colors">Daklekkage</h3>
                    <p className="text-slate-600 text-sm">Snelle reparatie van lekkages in dak en goot</p>
                  </div>
                  <div className="flex items-center justify-center text-tbgs-red font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Meer info <i className="fas fa-arrow-right ml-2 text-sm"></i>
                  </div>
                </div>
              </div>
            </Link>
            ...
            {/* Schoorsteen Service */}
            <Link href="/nl/eindhoven/schoorsteenreparatie">
              <div className="group bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:border-tbgs-blue transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl flex items-center justify-center mx-auto group-hover:from-tbgs-blue group-hover:to-blue-600 transition-all duration-500">
                    <i className="fas fa-fire text-2xl text-tbgs-blue group-hover:text-white transition-colors duration-500"></i>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-tbgs-blue transition-colors">Schoorsteenreparatie</h3>
                    <p className="text-slate-600 text-sm">Onderhoud en reparatie van alle schoorsteentypen</p>
                  </div>
                  <div className="flex items-center justify-center text-tbgs-blue font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Meer info <i className="fas fa-arrow-right ml-2 text-sm"></i>
                  </div>
                </div>
              </div>
            ...
            {/* Onderhoud Service */}
            <Link href="/nl/eindhoven/onderhoud">
              <div className="group bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:border-tbgs-green transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-50 to-green-100 rounded-xl flex items-center justify-center mx-auto group-hover:from-tbgs-green group-hover:to-green-600 transition-all duration-500">
                    <i className="fas fa-wrench text-2xl text-tbgs-green group-hover:text-white transition-colors duration-500"></i>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-tbgs-green transition-colors">Onderhoud</h3>
                    <p className="text-slate-600 text-sm">Preventief en curatief onderhoud aan woningen</p>
                  </div>
                  <div className="flex items-center justify-center text-tbgs-green font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Meer info <i className="fas fa-arrow-right ml-2 text-sm"></i>
                  </div>
                </div>
              </div>
            ...
            {/* Renovatie Service */}
            <Link href="/nl/eindhoven/renovatie">
              <div className="group bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl hover:border-tbgs-orange transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl flex items-center justify-center mx-auto group-hover:from-tbgs-orange group-hover:to-orange-600 transition-all duration-500">
                    <i className="fas fa-hammer text-2xl text-tbgs-orange group-hover:text-white transition-colors duration-500"></i>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-tbgs-orange transition-colors">Renovatie</h3>
                    <p className="text-slate-600 text-sm">Complete woningrenovaties van klein tot groot</p>
                  </div>
                  <div className="flex items-center justify-center text-tbgs-orange font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Meer info <i className="fas fa-arrow-right ml-2 text-sm"></i>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-tbgs-navy to-blue-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Heeft u een specifiek probleem?</h3>
              <p className="text-xl mb-6 opacity-90">Onze specialisten staan klaar om u te helpen met een gratis inspectie en advies op maat.</p>
              <button 
                onClick={onOpenContactModal}
