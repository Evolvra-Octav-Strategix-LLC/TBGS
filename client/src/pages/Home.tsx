    ...
    <>
      ...
      <section id="contact" className="py-8 lg:py-12 bg-tbgs-navy text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-6 opacity-90">WhatsApp direct <a href="https://wa.me/31614595142" className="text-yellow-300 font-bold">061 459 5142</a> of vraag een gratis inspectie aan</p>
          <button 
            onClick={onOpenContactModal}
