    ...
    <>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <Link href="/schoorsteen/schoorsteen-verwijderen" className="text-tbgs-blue font-semibold hover:text-blue-700 transition-colors cursor-pointer">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Onze <span className="text-tbgs-blue">Schoorsteen Specialisten</span> in uw Regio
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              TBGS schoorsteenspecialisten zijn actief in heel Nederland en België. Vind uw lokale schoorsteenveger voor snelle service en persoonlijk advies.
            </p>
          </div>
