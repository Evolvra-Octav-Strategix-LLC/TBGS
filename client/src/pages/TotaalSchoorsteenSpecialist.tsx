              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-tbgs-blue rounded-full flex items-center justify-center relative z-10">
                    <img src={certifiedIcon} alt="Gecertificeerd" className="w-6 h-6 object-contain brightness-0 invert" />
                  </div>
                  <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={cleaningIcon} alt="Schoorsteenvegen" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={removalIcon} alt="Schoorsteen Verwijderen" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={repairIcon} alt="Schoorsteenreparatie" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={replacementIcon} alt="Schoorsteen Vervanging" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={renovationIcon} alt="Schoorsteen Renovatie" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-tbgs-blue rounded-full flex items-center justify-center mb-4 relative z-10">
                <img src={emergencyIcon} alt="Spoedservice 24/7" className="w-8 h-8 object-contain brightness-0 invert" />
              </div>
