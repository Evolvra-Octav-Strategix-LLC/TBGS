...
export default function RetieRenovatie({ onOpenContactModal }: RetieRenovatieProps) {
  ...
  const whatsappUrl = "https://wa.me/31614595142?text=Hallo,%20ik%20heb%20een%20vraag%20over%20renovatie%20in%20Retie";

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
      <Helmet>
        <title>Renovatie Specialist Retie | TBGS | Complete Woningrenovatie België</title>
        <meta name="description" content="Professional renovatie specialist in Retie, België. TBGS realiseert complete woningrenovaties, badkamerrenovaties en keukenrenovaties. Belgische specialist." />
        <meta name="keywords" content="renovatie Retie, woningrenovatie België, badkamerrenovatie, keukenrenovatie, verbouwing België, renovatiebedrijf, TBGS Retie" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Renovatie Specialist Retie | TBGS | Complete Woningrenovatie België" />
        <meta property="og:description" content="Professional renovatie specialist in Retie, België. TBGS realiseert complete woningrenovaties, badkamerrenovaties en keukenrenovaties." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tbgs.nl/be/retie/renovatie" />
        <meta property="og:image" content="https://tbgs.nl/images/tbgs-renovatie-retie.jpg" />
        ...
        <link rel="canonical" href="https://tbgs.nl/be/retie/renovatie" />
        <link rel="alternate" hreflang="nl-nl" href="https://tbgs.nl/nl/retie/renovatie" />
      ...
      <LocalSEOSchema 
        businessData={{
          name: "TBGS Renovatie Specialist Retie",
          address: {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Complete Renovaties Retie, België</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Expert <span className="text-orange-200">Renovatie</span> in Retie
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-orange-100 leading-relaxed">
              Van complete woningrenovaties tot specifieke ruimteverbouwingen in Retie, België. 
              Wij transformeren uw woning naar uw dromen met Nederlandse vakmanschap en Belgische service.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Renovatiediensten in Retie, België
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-orange-100 hover:border-orange-200 transition-all duration-300 hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Complete woningrenovaties in Retie. Van klein tot groot project met Belgische normen.
                </p>
            ...
            <Card className="border-orange-100 hover:border-orange-200 transition-all duration-300 hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Luxe badkamerrenovaties met moderne sanitair en tijdloze afwerking in Retie.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-20 bg-orange-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Waarom TBGS voor Renovatie in Retie?
              </h2>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Volledig bekend met Belgische bouwvoorschriften en vergunningsprocedures.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Renovatieservice in Retie en Omgeving
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Wij realiseren renovaties in Retie en directe omgeving in België
            </p>
          </div>
