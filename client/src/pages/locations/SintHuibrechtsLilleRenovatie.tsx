...
export default function SintHuibrechtsLilleRenovatie({ onOpenContactModal }: SintHuibrechtsLilleRenovatieProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Complete woningrenovaties in Sint-Huibrechts-Lille door ervaren vakspecialisten. Van badkamer tot zolder met kwaliteit en vakmanschap."
      pageTitle="Renovatie Sint-Huibrechts-Lille | TBGS - Complete Woningrenovatie"
      metaDescription="Renovatie in Sint-Huibrechts-Lille? ✓ Complete woningrenovatie ✓ Badkamer & keuken ✓ 25+ jaar ervaring ✓ Van ontwerp tot oplevering. Gratis offerte!"
      
      heroDescription="Complete woningrenovaties in Sint-Huibrechts-Lille door ervaren vakspecialisten. Van kleinschalige verbouwingen tot complete renovaties. Wij realiseren uw droomhuis met kwaliteit en vakmanschap."
      problemsTitle="Renovatie Uitdagingen in Sint-Huibrechts-Lille Woningen"
      problems={[
      ...
      solutionsTitle="TBGS Renovatie Aanpak Sint-Huibrechts-Lille"
      solutions={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in woningrenovaties in Sint-Huibrechts-Lille en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoelang duurt een complete woningrenovatie in Sint-Huibrechts-Lille gemiddeld?",
        ...
        {
          question: "Regelen jullie ook de vergunningen voor renovaties in Sint-Huibrechts-Lille?",
          answer: "Ja, wij begeleiden u bij het aanvragen van benodigde vergunningen bij gemeente Sint-Huibrechts-Lille. We kennen de lokale procedures en eisen goed."
        },
        {
          question: "Hebben jullie ervaring met karakteristieke Limburgse bouwstijlen?",
          answer: "Absoluut! We respecteren altijd de architectonische stijl en combineren dit met moderne technieken en comfort. Sint-Huibrechts-Lille heeft een rijke bouwhistorie die we graag behouden."
        },
        {
        ...
        {
          question: "Wat kost een renovatie in Sint-Huibrechts-Lille gemiddeld?",
