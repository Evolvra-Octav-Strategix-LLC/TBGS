...
export default function GeldropDaklekkage() {
  const [isContactModalOpen, setIsContactModalOpen] = useState(false);

  const whatsappUrl = "https://wa.me/31614595142?text=Hallo,%20ik%20heb%20een%20vraag%20over%20daklekkage%20in%20Geldrop";

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      <LocalSEOSchema 
        businessData={{
          name: "TBGS Daklekkage Specialist Geldrop",
          address: {
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Daklekkage Specialist Geldrop</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Daklekkage in <span className="text-yellow-400">Geldrop</span>?
              <br />Wij Helpen Direct!
            </h1>
            
            <p className="text-xl md:text-2xl text-red-100 mb-8 leading-relaxed">
              Professionele daklekkage reparatie in Geldrop en omgeving. 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center text-black font-semibold mb-2 md:mb-0">
              ...
              <span>Acute daklekkage in Geldrop? Bel direct!</span>
            </div>
      ...
      {/* About Geldrop Section */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Daklekkage Specialist in <span className="text-red-600">Geldrop</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Als lokale dakspecialist in Geldrop kennen wij de gemeente en haar unieke uitdagingen. 
                Van de historische huizen in het centrum tot de nieuwere wijken, wij hebben ervaring met alle daktypen.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  Waarom TBGS voor daklekkage in Geldrop?
                </h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Volledig bekend met Geldropse bouwstijlen en weersomstandigheden</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Vanuit Eindhoven binnen 30 minuten in Geldrop</p>
                    </div>
                  </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8">
                  <h3 className="text-xl font-bold text-gray-900 mb-6">Onze Services in Geldrop</h3>
                  ...
                  <div className="mt-6 p-4 bg-white rounded-xl">
                    <p className="text-sm text-gray-600 text-center">
                      <strong>Geldrop gemeente info:</strong> Actief in alle wijken inclusief 
                      Centrum, Hoog Geldrop, Zesgehuchten en industriegebieden.
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Service Areas in Geldrop */}
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
              Servicegebieden in <span className="text-red-600">Geldrop</span>
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-red-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Geldrop Centrum</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Historische huizen en monumentale panden in het hart van Geldrop.
                  </p>
                  <Badge variant="outline" className="text-red-600 border-red-600">Alle daktypen</Badge>
                </CardContent>
              </Card>
              
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-red-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Hoog Geldrop</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Nieuwere woonwijken met moderne dakconstructies en isolatie.
                  </p>
                  <Badge variant="outline" className="text-red-600 border-red-600">Moderne daken</Badge>
                </CardContent>
              </Card>
              
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-red-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Zesgehuchten</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Landelijke omgeving met diverse dakvormen en materialen.
                  </p>
            ...
            <div className="text-center">
              <p className="text-gray-600 mb-6">
                Onze dakspecialisten zijn actief in heel Geldrop en omliggende gebieden. 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Andere Services in <span className="text-red-600">Geldrop</span>
            </h2>
