...
interface GeldropDaklekkageProps {
  onOpenContactModal: () => void;
}

export default function GeldropDaklekkage({ onOpenContactModal }: GeldropDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professionele daklekkage reparatie in Geldrop. Snelle service, garantie, 25+ jaar ervaring."
      pageTitle="Daklekkage Reparatie Geldrop | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Geldrop? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Geldrop en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Geldrop"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Geldrop en de regio Brabant."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Geldrop ter plaatse zijn?",
        ...
        {
          question: "Wat kost daklekkage reparatie in Geldrop gemiddeld?",
        ...
        {
          question: "Hebben jullie ervaring met Geldrop-woningen?",
          answer: "Ja, we kennen de karakteristieke bouwstijlen en dakconstructies in Geldrop goed. Van moderne woningen tot traditionele panden."
        },
        {
          question: "Kunnen jullie ook preventief dakonderhoud uitvoeren?",
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Geldrop."
        }
      ]}
