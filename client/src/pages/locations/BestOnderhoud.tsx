...
export default function BestOnderhoud({ onOpenContactModal }: BestOnderhoudProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professioneel onderhoud van woningen en bedrijfspanden in Best. Preventief onderhoud, reparaties en technische diensten."
      pageTitle="Onderhoud Best | TBGS - Betrouwbaar Woningonderhoud"
      metaDescription="Onderhoud in Best? ✓ Preventief onderhoud ✓ Snelle service ✓ Vaste contactpersoon ✓ 25+ jaar ervaring in Best!"
      
      heroDescription="Professioneel onderhoud van woningen en bedrijfspanden in Best door lokale specialisten. Preventief onderhoud, snelle reparaties en technische diensten voor een zorgeloze woning."
      problemsTitle="Veelvoorkomende Onderhoudsproblemen in Best"
      problems={[
        "Achterstallig onderhoud aan karakteristieke Best-woningen",
      ...
      solutionsTitle="TBGS Onderhoud Aanpak Best"
      solutions={[
      ...
      benefits={[
        {
          ...
          description: "Jaarlijkse onderhoudscontracten specifiek voor Best-woningen. Zo blijft uw woning altijd in topconditie."
        },
        {
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar de betrouwbare onderhoudspartner voor inwoners van Best en omgeving."
        },
        {
          icon: <Users className="w-6 h-6" />,
          title: "Vaste Contactpersoon",
          description: "Altijd dezelfde aanspreekpersoon die uw Best-woning en wensen kent. Persoonlijke service staat centraal."
        },
        {
      ...
      faqs={[
        {
          question: "Welke onderhoudsdiensten bieden jullie in Best?",
        ...
        {
          question: "Hoe vaak moet ik onderhoud laten uitvoeren in Best?",
        ...
        {
          question: "Geven jullie garantie op onderhoudswerkzaamheden in Best?",
