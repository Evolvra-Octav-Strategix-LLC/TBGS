...
export default function RetieOnderhoud({ onOpenContactModal }: RetieOnderhoudProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professioneel onderhoud van woningen en bedrijfspanden in Retie. Preventief onderhoud, reparaties en technische diensten."
      pageTitle="Onderhoud Retie | TBGS - Betrouwbaar Woningonderhoud"
      metaDescription="Onderhoud in Retie? ✓ Preventief onderhoud ✓ Snelle service ✓ Vaste contactpersoon ✓ 25+ jaar ervaring!"
      
      heroDescription="Professioneel onderhoud van woningen en bedrijfspanden in Retie door lokale specialisten. Preventief onderhoud, snelle reparaties en technische diensten voor een zorgeloze woning."
      problemsTitle="Veelvoorkomende Onderhoudsproblemen in Retie"
      problems={[
        "Achterstallig onderhoud aan karakteristieke Kempense woningen",
      ...
      solutionsTitle="TBGS Onderhoud Aanpak Retie"
      solutions={[
      ...
      benefits={[
        {
          ...
          description: "Jaarlijkse onderhoudscontracten specifiek voor Retie-woningen. Zo blijft uw woning altijd in topconditie."
        },
        {
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar de betrouwbare onderhoudspartner voor inwoners van Retie en de Kempen."
        },
        {
      ...
      faqs={[
        {
          question: "Wat voor onderhoud voeren jullie uit in Retie?",
        ...
        {
          question: "Hebben jullie vaste onderhoudscontracten voor Retie?",
        ...
        {
          question: "Hoe snel kunnen jullie bij spoedklussen in Retie?",
        ...
        },
        {
          ...
          answer: "Ja, we werken in de hele Kempen inclusief Retie. We kennen de lokale omstandigheden en eisen goed."
        },
        {
