...
interface PeltDaklekkageProps {
  onOpenContactModal: () => void;
}

export default function PeltDaklekkage({ onOpenContactModal }: PeltDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      pageTitle="Daklekkage Reparatie Pelt | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Pelt? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Pelt en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Pelt"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Pelt en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Pelt ter plaatse zijn?",
        ...
        {
          question: "Wat kost daklekkage reparatie in Pelt gemiddeld?",
        ...
        },
        {
          ...
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Pelt."
        }
      ]}
