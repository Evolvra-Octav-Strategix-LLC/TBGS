...
export default function HamontRenovatie() {
  ...
  return (
    <>
      <Helmet>
        <title>Renovatie Hamont | TBGS Specialisten | Totale Woningrenovatie</title>
        <meta name="description" content="Professionele renovatie in Hamont ✓ Badkamer & keuken renovatie ✓ Volledige woningrenovatie ✓ 25+ jaar ervaring ✓ Belgische specialisten ✓ Offerte op maat" />
        <meta name="keywords" content="renovatie Hamont, woningrenovatie, badkamerrenovatie, keukenrenovatie, verbouwing Hamont, aannemer renovatie" />
        <link rel="canonical" href="https://www.tbgs.nl/hamont/renovatie" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Renovatie Hamont | TBGS Specialisten" />
        <meta property="og:description" content="Professionele renovatie in Hamont. Van badkamer tot volledige woningrenovatie. 25+ jaar ervaring. Offerte op maat." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tbgs.nl/hamont/renovatie" />
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                realiseren uw droomrenovatie in Hamont met Belgische vakmanschap en moderne technieken.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag informatie over renovatie in Hamont`, '_blank')}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Complete renovatieoplossingen voor uw woning in Hamont
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-orange-50 to-orange-100/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Uw betrouwbare renovatiepartner in Hamont
              </p>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Renovatie in Hamont en Omgeving
            </h2>
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Hamont, met zijn karakteristieke Limburgse architectuur, biedt unieke mogelijkheden 
                voor renovatieprojecten. Onze specialisten combineren respect voor de traditionele 
                bouwstijl met moderne comfort en energiebesparende technieken.
              </p>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Gratis adviesgesprek en offerte op maat voor uw renovatie in Hamont
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag een offerte voor renovatie in Hamont`, '_blank')}
