...
export default function HamontAchelOnderhoud() {
  ...
  return (
    <>
      <Helmet>
        <title>Onderhoud Hamont-Achel | TBGS Specialisten | Preventief Bouwonderhoud</title>
        <meta name="description" content="Professioneel bouwonderhoud in Hamont-Achel ✓ Dakonderhoud ✓ Gootreiniging ✓ Schoorsteenonderhoud ✓ Preventief onderhoud ✓ Onderhoudscontracten ✓ Lokale specialisten" />
        <meta name="keywords" content="onderhoud Hamont-Achel, dakonderhoud, gootreiniging, schoorsteenonderhoud, bouwonderhoud, preventief onderhoud Hamont-Achel" />
        <link rel="canonical" href="https://www.tbgs.nl/hamont-achel/onderhoud" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Onderhoud Hamont-Achel | TBGS Specialisten" />
        <meta property="og:description" content="Professioneel bouwonderhoud in Hamont-Achel. Dakonderhoud, gootreiniging en preventief onderhoud door lokale specialisten." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tbgs.nl/hamont-achel/onderhoud" />
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Preventief bouwonderhoud en snelle reparaties in Hamont-Achel. Van dakonderhoud tot 
                gootreiniging - onze lokale specialisten zorgen voor optimaal onderhoud van uw eigendom.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag informatie over onderhoud in Hamont-Achel`, '_blank')}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Complete onderhoudsoplossingen voor uw eigendom in Hamont-Achel
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-green-50 to-green-100/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Uw betrouwbare onderhoudspartner in Hamont-Achel
              </p>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Bouwonderhoud in Hamont-Achel en Omgeving
            </h2>
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Het unieke klimaat van Hamont-Achel, met zijn wisselende weersomstandigheden en 
                natuurlijke omgeving, vereist regelmatig en professioneel bouwonderhoud. Onze 
                specialisten kennen de lokale uitdagingen en bieden preventieve oplossingen.
              </p>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-green-600 to-green-700 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Gratis inspectie en onderhoudsadvies voor uw eigendom in Hamont-Achel
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag een onderhoudscontrole in Hamont-Achel`, '_blank')}
