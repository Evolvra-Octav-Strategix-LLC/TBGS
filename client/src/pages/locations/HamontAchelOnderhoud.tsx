...
interface HamontAchelOnderhoudProps {
  onOpenContactModal: () => void;
}

export default function HamontAchelOnderhoud({ onOpenContactModal }: HamontAchelOnderhoudProps) {
  return (
    <ServiceLocationTemplate
      ...
      pageTitle="Onderhoud Hamont-Achel | TBGS - Betrouwbaar Woningonderhoud"
      metaDescription="Onderhoud in Hamont-Achel? ✓ Preventief onderhoud ✓ Snelle service ✓ Vaste contactpersoon ✓ 25+ jaar ervaring!"
      
      heroDescription="Professioneel onderhoud van woningen en bedrijfspanden in Hamont-Achel door lokale specialisten. Preventief onderhoud, snelle reparaties en technische diensten voor een zorgeloze woning."
      problemsTitle="Veelvoorkomende Onderhoudsproblemen in Hamont-Achel"
      problems={[
      ...
      solutionsTitle="TBGS Onderhoud Aanpak Hamont-Achel"
      solutions={[
      ...
      benefits={[
        {
          ...
          description: "Jaarlijkse onderhoudscontracten specifiek voor Hamont-Achel-woningen. Zo blijft uw woning altijd in topconditie."
        },
        {
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar de betrouwbare onderhoudspartner voor inwoners van Hamont-Achel en omgeving."
        },
        {
      ...
      faqs={[
        {
          question: "Wat voor onderhoud voeren jullie uit in Hamont-Achel?",
        ...
        {
          question: "Hoe snel kunnen jullie bij spoedklussen in Hamont-Achel?",
