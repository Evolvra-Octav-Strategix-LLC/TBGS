...
export default function LommelDaklekkage({ onOpenContactModal }: LommelDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      pageTitle="Daklekkage Reparatie Lommel | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Lommel? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Lommel en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Lommel"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Lommel en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Lommel ter plaatse zijn?",
        ...
        {
          question: "Wat kost daklekkage reparatie in Lommel gemiddeld?",
        ...
        },
        {
          ...
          answer: "Ja, we werken in heel Belgisch Limburg inclusief Lommel. Onze Nederlandse expertise en jarenlange ervaring stellen we graag ter beschikking."
        },
        {
          question: "Kunnen jullie ook preventief dakonderhoud uitvoeren?",
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Lommel."
        }
      ]}
