...
export default function SonEnBreugelRenovatie({ onOpenContactModal }: SonEnBreugelRenovatieProps) {
  ...
  const whatsappUrl = "https://wa.me/31614595142?text=Hallo,%20ik%20heb%20een%20vraag%20over%20renovatie%20in%20Son%20en%20Breugel";

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
      <Helmet>
        <title>Renovatie Specialist Son en Breugel | TBGS | Complete Woningrenovatie</title>
        <meta name="description" content="Professional renovatie specialist in Son en Breugel. TBGS realiseert complete woningrenovaties, badkamerrenovaties en keukenrenovaties. Lokale specialist." />
        <meta name="keywords" content="renovatie Son en Breugel, woningrenovatie, badkamerrenovatie, keukenrenovatie, verbouwing, renovatiebedrijf, TBGS Son en Breugel" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Renovatie Specialist Son en Breugel | TBGS | Complete Woningrenovatie" />
        <meta property="og:description" content="Professional renovatie specialist in Son en Breugel. TBGS realiseert complete woningrenovaties, badkamerrenovaties en keukenrenovaties." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tbgs.nl/nl/son-en-breugel/renovatie" />
        <meta property="og:image" content="https://tbgs.nl/images/tbgs-renovatie-son-en-breugel.jpg" />
        ...
        <link rel="canonical" href="https://tbgs.nl/nl/son-en-breugel/renovatie" />
        <link rel="alternate" hreflang="nl-be" href="https://tbgs.nl/be/son-en-breugel/renovatie" />
      ...
      <LocalSEOSchema 
        businessData={{
          name: "TBGS Renovatie Specialist Son en Breugel",
          address: {
          ...
          rating: { ratingValue: 4.8, reviewCount: 153 }
        }}
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Complete Renovaties Son en Breugel</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Expert <span className="text-orange-200">Renovatie</span> in Son en Breugel
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-orange-100 leading-relaxed">
              Van complete woningrenovaties tot specifieke ruimteverbouwingen in Son en Breugel. 
              Wij transformeren uw woning naar uw dromen met vakmanschap en lokale expertise.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Renovatiediensten in Son en Breugel
            </h2>
            ...
            <Card className="border-orange-100 hover:border-orange-200 transition-all duration-300 hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Complete woningrenovaties in Son en Breugel. Van klein tot groot project.
                </p>
      ...
      <section className="py-20 bg-orange-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Waarom TBGS voor Renovatie in Son en Breugel?
              </h2>
              <p className="text-xl text-gray-600">
                Lokale expertise en jarenlange ervaring in Son en Breugel
              </p>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Als Brabants bedrijf kennen wij Son en Breugel perfect. Korte lijnen en snelle service.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Geen verrassingen. Transparante offerte met duidelijke kostenverdeling.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Korte doorlooptijden door efficiënte planning en projectmanagement.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Renovatieservice in Son en Breugel
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Wij realiseren renovaties in heel Son en Breugel en omgeving
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Start Uw Renovatie in Son en Breugel
          </h2>
