...
interface WaalreOnderhoudProps {
  onOpenContactModal: () => void;
}

export default function WaalreOnderhoud({ onOpenContactModal }: WaalreOnderhoudProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professioneel onderhoud van woningen en bedrijfspanden in Waalre. Preventief onderhoud, reparaties en technische diensten."
      pageTitle="Onderhoud Waalre | TBGS - Betrouwbaar Woningonderhoud"
      metaDescription="Onderhoud in Waalre? ✓ Preventief onderhoud ✓ Snelle service ✓ Vaste contactpersoon ✓ 25+ jaar ervaring!"
      
      heroDescription="Professioneel onderhoud van woningen en bedrijfspanden in Waalre door lokale specialisten. Preventief onderhoud, snelle reparaties en technische diensten voor een zorgeloze woning."
      problemsTitle="Veelvoorkomende Onderhoudsproblemen in Waalre"
      problems={[
        "Achterstallig onderhoud aan exclusieve Waalre-woningen",
        "Schilderwerk dat onderhoud nodig heeft door lokale omstandigheden", 
        "Kleine reparaties die uitgroeien tot grote problemen",
        "Gebrek aan tijd voor regelmatig onderhoud van drukke professionals",
        "Verschillende aannemers voor verschillende klussen coördineren"
      ]}
      solutionsTitle="TBGS Onderhoud Aanpak Waalre"
      solutions={[
      ...
      benefits={[
        {
          ...
          description: "Jaarlijkse onderhoudscontracten specifiek voor Waalre-woningen. Zo blijft uw woning altijd in topconditie."
        },
        {
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar de betrouwbare onderhoudspartner voor inwoners van Waalre en omgeving."
        },
        {
      ...
      faqs={[
        {
          question: "Wat voor onderhoud voeren jullie uit in Waalre?",
        ...
        {
          question: "Hebben jullie vaste onderhoudscontracten voor Waalre?",
        ...
        {
          question: "Hoe snel kunnen jullie bij spoedklussen in Waalre?",
        ...
        {
          question: "Hebben jullie ervaring met exclusieve woningen in Waalre?",
