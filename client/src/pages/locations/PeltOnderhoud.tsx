...
export default function PeltOnderhoud() {
  ...
  return (
    <>
      <Helmet>
        <title>Onderhoud Pelt | TBGS Specialisten | Preventief Bouwonderhoud</title>
        <meta name="description" content="Professioneel bouwonderhoud in Pelt ✓ Dakonderhoud ✓ Gootreiniging ✓ Schoorsteenonderhoud ✓ Preventief onderhoud ✓ Onderhoudscontracten ✓ Lokale specialisten" />
        <meta name="keywords" content="onderhoud Pelt, dakonderhoud, gootreiniging, schoorsteenonderhoud, bouwonderhoud, preventief onderhoud Pelt" />
        <link rel="canonical" href="https://www.tbgs.nl/pelt/onderhoud" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Onderhoud Pelt | TBGS Specialisten" />
        <meta property="og:description" content="Professioneel bouwonderhoud in Pelt. Dakonderhoud, gootreiniging en preventief onderhoud door lokale specialisten." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tbgs.nl/pelt/onderhoud" />
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Preventief bouwonderhoud en snelle reparaties in Pelt. Van dakonderhoud tot 
                gootreiniging - onze lokale specialisten zorgen voor optimaal onderhoud van uw eigendom.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag informatie over onderhoud in Pelt`, '_blank')}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Complete onderhoudsoplossingen voor uw eigendom in Pelt
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-green-50 to-green-100/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Uw betrouwbare onderhoudspartner in Pelt
              </p>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Bouwonderhoud in Pelt en Omgeving
            </h2>
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-8 mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Pelt's moderne infrastructuur en gevarieerde woningbouw vereisen gespecialiseerd 
                onderhoud. Onze ervaren technici kennen de uitdagingen van zowel traditionele als 
                moderne constructies in deze dynamische gemeente.
              </p>
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• Moderne woningen onderhoud</li>
                    <li>• Periodieke gootinspecties</li>
                    <li>• Energetisch onderhoud</li>
                    <li>• Preventieve dakcontroles</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-green-600 to-green-700 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Gratis inspectie en onderhoudsadvies voor uw eigendom in Pelt
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hallo, ik wil graag een onderhoudscontrole in Pelt`, '_blank')}
