...
export default function SintHuibrechtsLilleDaklekkage() {
  ...
  return (
    <>
      <Helmet>
        <title>Daklekkage Sint-Huibrechts-Lille | TBGS Specialisten | 24/7 Daklekkage Reparatie</title>
        <meta name="description" content="Daklekkage in Sint-Huibrechts-Lille? ✓ 24/7 spoedreparatie ✓ Ervaren dakspecialisten ✓ Directe oplossing ✓ Belgische kwaliteit ✓ Gratis inspectie ✓ Binnen 2 uur ter plaatse" />
        <meta name="keywords" content="daklekkage Sint-Huibrechts-Lille, lekkend dak, daklekkage reparatie, dakdekker, spoeddienst daklekkage" />
        <link rel="canonical" href="https://www.tbgs.nl/sint-huibrechts-lille/daklekkage" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Daklekkage Sint-Huibrechts-Lille | TBGS Specialisten" />
        <meta property="og:description" content="Daklekkage in Sint-Huibrechts-Lille? 24/7 spoedreparatie door ervaren specialisten. Binnen 2 uur ter plaatse." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tbgs.nl/sint-huibrechts-lille/daklekkage" />
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Daklekkage in Sint-Huibrechts-Lille? Onze ervaren specialisten zijn 24/7 beschikbaar 
                voor snelle en professionele daklekkage reparaties. Binnen 2 uur ter plaatse!
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button 
                  onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Spoed! Daklekkage in Sint-Huibrechts-Lille - kunnen jullie komen kijken?`, '_blank')}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Snelle en duurzame oplossingen voor al uw dakproblemen in Sint-Huibrechts-Lille
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-red-50 to-red-100/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Uw betrouwbare daklekkage specialist in Sint-Huibrechts-Lille
              </p>
            </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Daklekkage Expertise in Sint-Huibrechts-Lille
            </h2>
            <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-2xl p-8 mb-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Sint-Huibrechts-Lille's kleinschalige gemeenschap en traditionele architectuur vereisen 
                specialistische daklekkage aanpak. Onze ervaren technici kennen de lokale bouwstijlen 
                en klimatologische uitdagingen die specifiek zijn voor deze charmante gemeente.
              </p>
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Karakteristieke dakvormen kennis</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-red-600 to-red-700 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Elke minuut telt bij daklekkage. Onze specialisten staan 24/7 voor u klaar in Sint-Huibrechts-Lille.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Spoed! Daklekkage in Sint-Huibrechts-Lille`, '_blank')}
            ...
            <p className="mt-6 text-red-100">
              ...
              24/7 beschikbaar • Binnen 2 uur ter plaatse in Sint-Huibrechts-Lille
            </p>
          </div>
        </section>
