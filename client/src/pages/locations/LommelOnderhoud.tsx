...
export default function LommelOnderhoud({ onOpenContactModal }: LommelOnderhoudProps) {
  ...
  const whatsappUrl = "https://wa.me/31614595142?text=Hallo,%20ik%20heb%20een%20vraag%20over%20onderhoud%20in%20Lommel";

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50">
      <Helmet>
        <title>Onderhoud Specialist Lommel | TBGS | 24/7 Bouwonderhoud België</title>
        <meta name="description" content="Professional onderhoud specialist in Lommel, België. TBGS biedt 24/7 bouwonderhoud, preventief onderhoud en spoedservice in België." />
        <meta name="keywords" content="onderhoud Lommel België, bouwonderhoud België, preventief onderhoud, spoedservice België, dakonderhoud, gevelonderhoud, TBGS Lommel" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Onderhoud Specialist Lommel | TBGS | 24/7 Bouwonderhoud België" />
        <meta property="og:description" content="Professional onderhoud specialist in Lommel, België. TBGS biedt 24/7 bouwonderhoud, preventief onderhoud en spoedservice." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tbgs.nl/be/lommel/onderhoud" />
        <meta property="og:image" content="https://tbgs.nl/images/tbgs-onderhoud-lommel.jpg" />
        ...
        <link rel="canonical" href="https://tbgs.nl/be/lommel/onderhoud" />
        <link rel="alternate" hreflang="nl-nl" href="https://tbgs.nl/nl/lommel/onderhoud" />
      ...
      <LocalSEOSchema 
        businessData={{
          name: "TBGS Onderhoud Specialist Lommel",
          address: {
          ...
          rating: { ratingValue: 4.9, reviewCount: 149 }
        }}
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-medium">24/7 Onderhoud Service Lommel, België</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Professional <span className="text-green-200">Onderhoud</span> in Lommel
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-green-100 leading-relaxed">
              Uw betrouwbare onderhoudspartner voor preventief en curatief onderhoud in Lommel, België. 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Onderhoudsdiensten in Lommel, België
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-green-100 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Professioneel dakonderhoud voor alle daktypen in Lommel. Van pannenvervanging tot complete dakrenovatie.
                </p>
            ...
            <Card className="border-green-100 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Compleet gevelonderhoud voor behoud van uw pand in Lommel. Van reiniging tot renovatie.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-20 bg-green-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Voordelen van TBGS Onderhoud in Lommel
              </h2>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Voor acute onderhoudsproblemen zijn wij 24/7 bereikbaar in Lommel en omgeving.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Onderhoudsservice in Lommel en Omgeving
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Wij bedienen Lommel en directe omgeving in België voor alle onderhoudswerkzaamheden
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Direct Contact voor Onderhoud in Lommel
          </h2>
