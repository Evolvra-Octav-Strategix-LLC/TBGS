...
export default function OverpeltDaklekkage({ onOpenContactModal }: OverpeltDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professionele daklekkage reparatie in Overpelt. Snelle service, garantie, 25+ jaar ervaring."
      pageTitle="Daklekkage Reparatie Overpelt | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Overpelt? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Overpelt en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Overpelt"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Overpelt en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Overpelt ter plaatse zijn?",
        ...
        {
          question: "Wat kost daklekkage reparatie in Overpelt gemiddeld?",
        ...
        {
          question: "Kennen jullie Overpelt en omgeving goed?",
          answer: "Ja, we hebben jarenlange ervaring in Overpelt en kennen de lokale bouwstijlen en dakvariaties goed. We zijn vertrouwd met de karakteristieke Limburgse architectuur."
        },
        {
        ...
        },
        {
          ...
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Overpelt."
        }
      ]}
