...
export default function GeldropRenovatie() {
  const [isContactModalOpen, setIsContactModalOpen] = useState(false);

  const whatsappUrl = "https://wa.me/31614595142?text=Hallo,%20ik%20heb%20een%20vraag%20over%20renovatie%20in%20Geldrop";

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
      <LocalSEOSchema 
        businessData={{
          name: "TBGS Renovatie Specialist Geldrop",
          address: {
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Renovatie Specialist Geldrop</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Renovatie in <span className="text-yellow-400">Geldrop</span>
              <br />Vakkundig Uitgevoerd
            </h1>
            
            <p className="text-xl md:text-2xl text-orange-100 mb-8 leading-relaxed">
              Complete woningrenovaties in Geldrop door ervaren vakspecialisten. 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center text-black font-semibold mb-2 md:mb-0">
              ...
              <span>Renovatieplannen in Geldrop? Vraag gratis advies!</span>
            </div>
      ...
      {/* About Geldrop Renovations */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Renovatie Specialist in <span className="text-orange-600">Geldrop</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Als lokale renovatiespecialist in Geldrop realiseren wij complete woningtransformaties. 
                Van karakteristieke pandjes in het centrum tot moderne woningen in nieuwere wijken.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  Waarom TBGS voor renovatie in Geldrop?
                </h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Bekend met Geldropse bouwstijlen en gemeentelijke procedures</p>
                    </div>
                  </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8">
                  <h3 className="text-xl font-bold text-gray-900 mb-6">Renovatie Services Geldrop</h3>
                  ...
                  <div className="mt-6 p-4 bg-white rounded-xl">
                    <p className="text-sm text-gray-600 text-center">
                      <strong>Geldrop specialiteit:</strong> Renovaties in karakteristieke woningen 
                      met respect voor originele architectuur.
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Renovation Types in Geldrop */}
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
              Renovatietypes in <span className="text-orange-600">Geldrop</span>
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-orange-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Historische Panden</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Respectvolle renovatie van karakteristieke woningen in Geldrop centrum.
                  </p>
                  <Badge variant="outline" className="text-orange-600 border-orange-600">Monumentaal</Badge>
                </CardContent>
              </Card>
              
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-orange-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Jaren '70 Woningen</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Modernisering en verduurzaming van woningen uit de jaren 70.
                  </p>
                  <Badge variant="outline" className="text-orange-600 border-orange-600">Modernisering</Badge>
                </CardContent>
              </Card>
              
              <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-orange-600">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">Nieuwbouw Woningen</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm mb-3">
                    Aanpassingen en uitbreidingen van moderne woningen.
                  </p>
                  <Badge variant="outline" className="text-orange-600 border-orange-600">Modern</Badge>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center">
              <p className="text-gray-600 mb-6">
                Elk renovatieproject in Geldrop wordt aangepakt met oog voor detail en vakmanschap. 
                Wij respecteren de eigenheid van uw woning en wijk.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Andere Services in <span className="text-orange-600">Geldrop</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Link href="/geldrop/onderhoud">
                <Card className="hover:shadow-xl transition-all duration-300 border-2 hover:border-orange-600 cursor-pointer">
                  ...
                  <CardContent>
                    <p className="text-gray-600 mb-4">
                      Preventief onderhoud en technische diensten voor woningen en bedrijfspanden in Geldrop.
                    </p>
                    <Badge className="bg-orange-100 text-orange-800 hover:bg-orange-200">Bekijk service →</Badge>
                  </CardContent>
                </Card>
