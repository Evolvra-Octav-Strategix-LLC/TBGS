...
export default function OverpeltRenovatie({ onOpenContactModal }: OverpeltRenovatieProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Complete woningrenovaties in Overpelt door ervaren vakspecialisten. Van badkamer tot zolder met kwaliteit en vakmanschap."
      pageTitle="Renovatie Overpelt | TBGS - Complete Woningrenovatie"
      metaDescription="Renovatie in Overpelt? ✓ Complete woningrenovatie ✓ Badkamer & keuken ✓ 25+ jaar ervaring ✓ Van ontwerp tot oplevering. Gratis offerte!"
      
      heroDescription="Complete woningrenovaties in Overpelt door ervaren vakspecialisten. Van kleinschalige verbouwingen tot complete renovaties. Wij realiseren uw droomhuis met kwaliteit en vakmanschap."
      problemsTitle="Renovatie Uitdagingen in Overpelt Woningen"
      problems={[
      ...
      solutionsTitle="TBGS Renovatie Aanpak Overpelt"
      solutions={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in woningrenovaties in Overpelt en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoelang duurt een complete woningrenovatie in Overpelt gemiddeld?",
        ...
        {
          question: "Regelen jullie ook de vergunningen voor renovaties in Overpelt?",
          answer: "Ja, wij begeleiden u bij het aanvragen van benodigde vergunningen bij gemeente Overpelt. We kennen de lokale procedures en eisen goed."
        },
        {
          question: "Hebben jullie ervaring met karakteristieke Limburgse bouwstijlen?",
          answer: "Absoluut! We respecteren altijd de architectonische stijl en combineren dit met moderne technieken en comfort. Overpelt heeft een rijke bouwhistorie die we graag behouden."
        },
        {
        ...
        {
          question: "Wat kost een renovatie in Overpelt gemiddeld?",
