...
interface PeltSchoorsteenProps {
  onOpenContactModal: () => void;
}

export default function PeltSchoorsteen({ onOpenContactModal }: PeltSchoorsteenProps) {
  return (
    <ServiceLocationTemplate
      ...
      pageTitle="Schoorsteen Service Pelt | TBGS - Reiniging & Onderhoud"
      metaDescription="Schoorsteen service in Pelt? ✓ Professionele reiniging ✓ Veiligheidscontrole ✓ 25+ jaar ervaring ✓ Gecertificeerde monteurs!"
      
      heroDescription="Professionele schoorsteenservice in Pelt en omgeving. Reiniging, inspectie en onderhoud door gecertificeerde specialisten. Veiligheid en kwaliteit gegarandeerd."
      problemsTitle="Veelvoorkomende Schoorsteen Problemen in Pelt"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in schoorsteenonderhoud in Pelt en Belgisch Limburg."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe vaak moet een schoorsteen in Pelt gereinigd worden?",
        ...
        },
        {
          ...
          answer: "Ja, we bedienen heel Pelt, inclusief Overpelt en Neerpelt. We kennen de fusiegemeente goed en hun specifieke schoorsteentypes."
        },
        {
          question: "Wat kost schoorsteenreiniging in Pelt?",
