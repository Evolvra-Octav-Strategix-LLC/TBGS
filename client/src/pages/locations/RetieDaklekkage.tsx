...
export default function RetieDaklekkage({ onOpenContactModal }: RetieDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professionele daklekkage reparatie in Retie. Snelle service, garantie, 25+ jaar ervaring."
      pageTitle="Daklekkage Reparatie Retie | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Retie? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Retie en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Retie"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Retie en de regio Kempen."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Retie ter plaatse zijn?",
        ...
        },
        {
          ...
          answer: "Ja, we werken in heel de Kempen inclusief Retie. Onze Nederlandse expertise en jarenlange ervaring stellen we graag ter beschikking."
        },
        {
          question: "Kunnen jullie ook preventief dakonderhoud uitvoeren?",
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Retie."
        }
      ]}
