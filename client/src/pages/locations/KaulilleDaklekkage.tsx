...
interface KaulilleDaklekkageProps {
  onOpenContactModal: () => void;
}

export default function KaulilleDaklekkage({ onOpenContactModal }: KaulilleDaklekkageProps) {
  return (
    <ServiceLocationTemplate
      ...
      serviceDescription="Professionele daklekkage reparatie in Kaulille. Snelle service, garantie, 25+ jaar ervaring."
      pageTitle="Daklekkage Reparatie Kaulille | TBGS - Snel & Betrouwbaar"
      metaDescription="Daklekkage in Kaulille? ✓ Binnen 24u ter plaatse ✓ 25+ jaar ervaring ✓ Volledige garantie. Bel direct voor snelle reparatie!"
      
      heroDescription="Professionele daklekkage reparatie in Kaulille en omgeving. Binnen 24 uur ter plaatse voor spoedgevallen. Volledig verzekerd en gecertificeerd met 25+ jaar ervaring."
      problemsTitle="Veelvoorkomende Daklekkage Problemen in Kaulille"
      problems={[
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Al meer dan 25 jaar specialist in daklekkage reparatie in Kaulille en de regio Kempen."
        },
        {
      ...
      faqs={[
        {
          question: "Hoe snel kunnen jullie bij daklekkage in Kaulille ter plaatse zijn?",
        ...
        {
          question: "Wat kost daklekkage reparatie in Kaulille gemiddeld?",
        ...
        },
        {
          ...
          answer: "Ja, we werken in heel de Kempen inclusief Kaulille. Onze Nederlandse expertise en jarenlange ervaring stellen we graag ter beschikking."
        },
        {
          question: "Kunnen jullie ook preventief dakonderhoud uitvoeren?",
          answer: "Absoluut! Preventief onderhoud voorkomt veel dakproblemen. We bieden onderhoudscontracten specifiek voor woningen in Kaulille."
        }
      ]}
