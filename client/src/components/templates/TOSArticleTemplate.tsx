          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a 
                  href="https://wa.me/31614595142?text=Hallo%20Team%20TBGS%2C%20ik%20heb%20een%20vraag%20over%20onderhoud"
                  target="_blank"
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Onze <strong>onderhoud specialisten</strong> zijn actief in heel Nederland en België. Vind uw lokale specialist voor snelle service.
                </p>
              </div>
