...
interface TSSArticleTemplateProps {
  // SEO Props
  title: string;
  description: string;
  url: string;
...
export default function TSSArticleTemplate({
  title,
  description,
  url,
  heroTitle,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <WhatsAppIcon className="mr-3" color="blue" />
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Gecertificeerde Schoorsteenvegers</div>
            ...
            {sections.map((section, index) => (
              <div key={index} className="mb-16">
                <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center">
                  {section.icon && renderIcon(section.icon, "w-6 h-6 text-tbgs-blue mr-4")}
                  {section.title}
                </h2>
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Onze <strong>schoorsteenvegers</strong> zijn actief in heel Nederland en België. Vind uw lokale specialist voor snelle service.
                </p>
              </div>
              
              <LocationAreasOnly 
                specialist="schoorsteen"
              />
            </div>
