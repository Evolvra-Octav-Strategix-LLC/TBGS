    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/">
            <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-2.5 lg:space-x-3 cursor-pointer">
              <img src={tbgsLogo} alt="TBGS Logo" className="w-7 h-7 xs:w-8 xs:h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 xl:w-12 xl:h-12 object-contain" />
              <div>
                <h1 className="text-[11px] xs:text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-bold text-tbgs-navy leading-tight">TBGS BV</h1>
                <p className="text-[9px] xs:text-[10px] sm:text-[11px] md:text-xs lg:text-sm xl:text-sm text-gray-600 whitespace-nowrap leading-tight">Totaal Bouw Groep Specialisten</p>
              </div>
            </div>
          </Link>
