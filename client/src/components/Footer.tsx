...
const tbgsLogo = "/img/TBGS%20545x642_1754935848756.webp";
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link href="/bouwen" className="group flex items-center space-x-3 text-white/70 hover:text-white transition-colors">
