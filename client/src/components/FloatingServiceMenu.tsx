...
// Using a placeholder image from available assets
                  ...
                  {selectedFiles.length === 0 ? (
                    <>
                      ...
                      <div 
                        ...
                        className="w-32 h-56 rounded-2xl overflow-hidden shadow-lg mb-6 cursor-pointer hover:shadow-xl transition-shadow bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center"
                      >
                        <div className="text-white text-center">
                          ...
                          <p className="text-sm font-medium">Foto toevoegen</p>
                        </div>
                      </div>
