  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pointer-events-none">
        <div 
          className="bg-white rounded-t-2xl sm:rounded-xl max-w-md sm:max-w-2xl lg:max-w-4xl w-full max-h-[85vh] sm:max-h-[90vh] overflow-y-auto pointer-events-auto shadow-xl"
